...
\documentclass[a4paper]{deedy-resume} % Use US Letter paper, change to a4paper for A4 
    ...
    \section{Projects}
    \runsubsection{BotLatexx}
    \descript{| Bot | \href{https://www.youtube.com/watch?v=P_5-_v2ttiU}{\bf Get it now}}
    ...
    \descript{| Android App | 2.2k+ | Backend | \href{https://play.google.com/store/apps/details?id=lnmiit.madclub.collegeplus}{\bf Play Store Link}}
    
    \location{April 2016 - May 2016 | October 2018}
    \begin{tabular}{rll}
    \textbullet{} & Reminder for events, lectures, mess menu, buses, library books, auto data updation.\\
    \textbullet{} & Automatically update DB, by uploading PDF files. \href{https://www.youtube.com/watch?v=SlszrEz5KJg}{\bf Demo}
    \end{tabular}
